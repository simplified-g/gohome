...
class _AddProperties extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => __AddPropertiesState();
}

class __AddPropertiesState extends State<_AddProperties> {
  Future<File> file;
